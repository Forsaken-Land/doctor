    ...
    init {
        ...
        packetMap(ProtocolState.PLAY) {
            ...
            whenS2C {
                ...
                register(0x11, SConfirmTransactionDecoder())
                register(0x14, WindowItemsDecoder())
                register(0x16, SetSlotDecoder())
            ...
            whenC2S {
                ...
                register(0x05, CConfirmTransactionEncoder())
                register(0x07, ClickWindowEncoder())
                register(0x08, CCloseWindowEncoder())
